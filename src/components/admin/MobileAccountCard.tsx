        ...
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 space-y-1">
            <div className="flex items-center gap-2">
              <p className="font-semibold text-sm truncate text-foreground">{account.name}</p>
              {account.is_default && (
                <Badge className="bg-primary/10 text-primary border-0 rounded-lg text-xs">پیش‌فرض</Badge>
              )}
            </div>
